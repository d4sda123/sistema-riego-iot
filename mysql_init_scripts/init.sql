...
CREATE USER 'emqx'@'%' IDENTIFIED BY '7FF161E4392ED9C72FB0A16957D80E57';
GRANT ALL PRIVILEGES ON sistema_riego.* TO 'emqx'@'%';
CREATE USER 'node-red'@'%' IDENTIFIED BY 'DE31DBF294ACA5D7BB0EA9624641CDF7';
GRANT ALL PRIVILEGES ON sistema_riego.* TO 'node-red'@'%';
CREATE USER 'flask'@'%' IDENTIFIED BY '20A1598BD2ADB0D3DEE274D2FB6FA0AC';
GRANT ALL PRIVILEGES ON sistema_riego.* TO 'flask'@'%';
CREATE USER 'rocketbot'@'%' IDENTIFIED BY 'F118A754D2C67CB39045106B73DA5066';
GRANT ALL PRIVILEGES ON sistema_riego.* TO 'rocketbot'@'%';
CREATE USER 'nginx'@'%' IDENTIFIED BY '15C6D653258B9E9A1216CBA9349B3051';
GRANT ALL PRIVILEGES ON npm.* TO 'nginx'@'%';
...
CALL addMQTTUser('user', 'F472645D80F0E615B0173F3AA818BBCE', 'user', 0);
