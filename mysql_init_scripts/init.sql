...
CREATE USER 'emqx'@'emqx' IDENTIFIED BY '7FF161E4392ED9C72FB0A16957D80E57';
GRANT ALL PRIVILEGES ON sistema_riego.* TO 'emqx'@'emqx';
CREATE USER 'node-red'@'node-red' IDENTIFIED BY 'DE31DBF294ACA5D7BB0EA9624641CDF7';
GRANT ALL PRIVILEGES ON sistema_riego.* TO 'node-red'@'node-red';
CREATE USER 'flask'@'flask' IDENTIFIED BY '20A1598BD2ADB0D3DEE274D2FB6FA0AC';
GRANT ALL PRIVILEGES ON sistema_riego.* TO 'flask'@'flask';
CREATE USER 'rocketbot'@'rocketbot' IDENTIFIED BY 'F118A754D2C67CB39045106B73DA5066';
GRANT ALL PRIVILEGES ON sistema_riego.* TO 'rocketbot'@'rocketbot';
